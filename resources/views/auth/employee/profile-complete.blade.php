...
<body>
    <div class="complete-container">
        ...
        <p class="complete-message">
            Your employee profile has been created. You can now start applying for jobs and managing your profile.
        </p>
        ...
        <div>
            <a href="{{ route('employee.profile') }}" class="btn">View My Profile</a>
