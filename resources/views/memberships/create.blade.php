...
<div class="form-container">
    <div class="form-header">
        <h1 class="form-title">Create Membership</h1>
        <div class="form-actions">
            <a href="{{ route('memberships.index') }}" class="btn btn-secondary">Back to List</a>
        </div>
    </div>

    <form method="POST" action="{{ route('memberships.store') }}" style="max-width: 800px;">
        @csrf
        ...
        <div class="form-group" style="margin-bottom: 16px;">
            ...
            <select name="membership_type" class="form-control" required>
                ...
                <option value="enterprise" {{ old('membership_type') == 'enterprise' ? 'selected' : '' }}>Enterprise</option>
            </select>
